...
public class WeatherTest {
	...
	public void testIfEndpointServeProperData() {
		weatherCollector.collectAndSave();
		 ...
		 WeatherData currentWeather = weatherCollector.collectCurrentWeather().block();
		 weatherCollector.collectAndSave();
		 
		 webClient.get().uri("/sun").exchange().expectBody(WeatherData.class).isEqualTo(currentWeather);
